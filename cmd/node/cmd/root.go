...
import (
	...
	"blockchain/app"
	"blockchain/app/params"
)

// NewRootCmd creates a new root command for the binary. It is called once in the
// main function.
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithViper(strings.ToUpper(app.Name))
...
func appExport(
	...
	if height != -1 {
		...
		App = app.NewApp(logger, db, traceStore, true, appOpts)
	}
